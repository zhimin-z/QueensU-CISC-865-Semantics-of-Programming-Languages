...
\Infer{nat-$\imp$Intro\noteassume{\fighi{x}}}
   {
   \ndassume{x}{Q \AND P \True}
   {
        \ndassume{\hspace*{-3ex}y}{Q \True}
        {
            \Infer{nat-$\imp$Intro\noteassume{\fighi{y}}}
            {
                \Infer{nat-$\AND$Elim2}
...
\Infer{seq-$\imp$Intro}
   ...
   {\xNDassume{x}{Q \AND P \True}|-(Q \imp P) \True}
   }
...
\begin{proof}
  ...
  \item Case: seq-$\imp$Elim
    ...
    \begin{llproof}
      \ePf{\Gamma}{A \True}  {By inversion}
      \ePf{\Gamma}{(A_1 \imp A) \True}  {By inversion}
      \ePf{\Gamma}{A_1 \True}  {By inversion}
      \Pf{}{}{(A_1 \imp A) \True~~~\text{under assumptions $\Gamma$}} {By IH}
      \Pf{}{}{A_1 \True~~~\text{under assumptions $\Gamma$}} {By IH}
      \Pf{}{}{A \True\text{~~~under assumptions $\Gamma$}}
        {By nat-$\imp$Elim}
    \end{llproof}
...
\Infer{type-choose}
     {
     \Infer{type-identity}{}
     {\emptyctx |- \lcabs{x}{x}:\Int -> \Int}
     \\
     \Infer{type-identity}{}
     {\emptyctx |- \lcabs{y}{y}:\Int -> \Int}
     }
     {
...
\begin{proof}
  ...
  \begin{llproof}
      %\ePf{\emptyctx}{\DC{M_1}{M_2} : S}  {By inversion on type-choose}
      \ePf{\emptyctx}{M_2 : S}  {By inversion on type-choose}
      %\Pf{}{}{\DC{M_1}{M_2} \down v}  {By inversion on eval-choose2}
      \Pf{}{}{M_2 \down v}  {By inversion on eval-choose2}
      \ePf{\emptyctx}{v : S}  {By IH}
  \end{llproof}
